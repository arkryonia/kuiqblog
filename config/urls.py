...
urlpatterns = [
    url(r'^pages/$', TemplateView.as_view(template_name='pages/home.html'), name="home"),
    url(r'^', include(weblog_urls, namespace="weblog")),
    ...
    # User management
    url(r'^users/', include("kuiqblog.users.urls", namespace="users")),
