...
A simple blog for simple usage made in Benin
...
.. code-block:: bash
    ...
    cd kuiqblog
    celery -A kuiqblog.taskapp worker -l info
...
To run the tests, enter the kuiqblog/tests directory and run the following commands::
